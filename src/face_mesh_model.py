...
class FaceMeshModel:
    ...
    def get_landmarks(self, image):
        ...
        if results.multi_face_landmarks:
            ...
            # Approximate indices for ear landmarks (for illustrative purposes)
            ear_landmarks = {
                "left_ear": landmarks[234],  # Approximate index for left ear
                "right_ear": landmarks[454]  # Approximate index for right ear
            }
